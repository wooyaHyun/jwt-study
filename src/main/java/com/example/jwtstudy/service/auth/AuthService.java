package com.example.jwtstudy.service.auth;
...
import com.example.jwtstudy.domain.token.RefreshToken;
import com.example.jwtstudy.domain.token.RefreshTokenRepository;
...
/**
 * packageName : com.example.jwtstudy.service.auth
...
public class AuthService {
    ...
    @Transactional
    public MemberResponseDto signup(MemberJoinRequestDto memberRequestDto) {
    ...
    @Transactional
    public TokenDto login(MemberJoinRequestDto memberRequestDto) {
